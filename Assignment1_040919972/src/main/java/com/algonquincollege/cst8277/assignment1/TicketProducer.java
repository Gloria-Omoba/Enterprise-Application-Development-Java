 ...
 * <b>Description</b></br>
 * </br>
 * Implements the {@link com.algonquincollege.cst8277.assignment1.Producer}
 * interface </br>
 *
...
public class TicketProducer implements Producer<Optional<Ticket>> {
    ...
    protected static final String SOMETHING_WENT_WRONG_CREATING_TICKET = "something went wrong creating ticket or adding to buffer";
    ...
    // STATISTICS_MSG_FMT is a SLF4J format string (with "{}" formatting anchors)
    // that
    // logs the number of elements produced and the elapsed time @see
    ...
    /**
     * Using POjo DAta Mocker (DOPAM), build random {@link Ticket}'s and add them to
     * the buffer
     *
