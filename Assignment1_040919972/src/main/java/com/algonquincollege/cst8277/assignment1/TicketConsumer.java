 ...
 * <b>Description</b></br>
 * </br>
 * Implements the {@link com.algonquincollege.cst8277.assignment1.Consumer}
 * interface </br>
 *
...
public class TicketConsumer implements Consumer<Optional<Ticket>> {
    ...
    // that
    // logs the number of elements consumed and the elapsed time @see
        ...
        while (!done) {
            try {
                ...
                if (oTicket.isPresent()) {
                    ...
                    // if there are other consumer threads, we should put the empty Optional back so
                    // they know to stop, too
